...
@Component({
  selector: 'app-instructor-form-edit',
  templateUrl: './instructor-form-edit.component.html',
  styleUrls: ['./instructor-form-edit.component.css']
})
export class InstructorFormEditComponent implements OnInit {
